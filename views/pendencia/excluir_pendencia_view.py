...
class ExcluirPendenciaView(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        self.exclusao_frame = ctk.CTkFrame(self.main_frame, fg_color="transparent")
        self.exclusao_frame.grid_rowconfigure(1, weight=0)
        self.exclusao_frame.grid_rowconfigure(1, weight=0)
        self.exclusao_frame.grid_rowconfigure(2, weight=0)
        self.exclusao_frame.grid_rowconfigure(3, weight=0)
        self.exclusao_frame.grid_columnconfigure(0, weight=0)
        self.exclusao_frame.grid_columnconfigure(1, weight=0)
        self.exclusao_frame.grid_columnconfigure(2, weight=0)
        self.exclusao_frame.grid_columnconfigure(3, weight=1)
        self.exclusao_frame.grid_columnconfigure(4, weight=0)
        self.exclusao_frame.grid(row=1, column=0, sticky="ew")

        ctk.CTkLabel(self.exclusao_frame, text="Cupom:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=0, column=0, padx=(40, 0), pady=(15, 0), sticky="e")
        self.entry_cupom = ctk.CTkEntry(self.exclusao_frame, font=FONTE_TEXTO, width=100, height=30, corner_radius=2)
        ...
        ctk.CTkFrame(self.exclusao_frame, height=2, fg_color=COR_LINHAS).grid(row=1, column=0, padx=(40, 290), pady=(15, 0), sticky="ew", columnspan=5)


        ctk.CTkLabel(self.exclusao_frame, text="Data:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=2, column=0, padx=(40, 0), pady=(15, 0), sticky="e")
        ...
        ctk.CTkLabel(self.exclusao_frame, text="Carga:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=3, column=0, padx=(40, 0), pady=(10, 0), sticky="e")
        self.entry_carga = ctk.CTkEntry(self.exclusao_frame, font=FONTE_TEXTO, width=100, height=30, corner_radius=2)
        self.entry_carga.grid(row=3, column=1, padx=(10, 0), pady=(10, 0), sticky="w")

        self.label_nome_rota = ctk.CTkLabel(self.exclusao_frame, text="", font=FONTE_TEXTO, text_color=COR_TEXTO)
        self.label_nome_rota.grid(row=3, column=3, padx=(25, 0), pady=(10, 0), sticky="w")


        ctk.CTkLabel(self.exclusao_frame, text="Código Cliente:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=4, column=0, padx=(40, 0), pady=(10, 0), sticky="e")
        self.entry_codigo_cliente = ctk.CTkEntry(self.exclusao_frame, font=FONTE_TEXTO, width=100, height=30, corner_radius=2)
        ...
        self.label_razao_social = ctk.CTkLabel(self.exclusao_frame, text="", font=FONTE_TEXTO, text_color=COR_TEXTO)
        self.label_razao_social.grid(row=4, column=3, padx=(25, 0), pady=(10, 0), sticky="w")

        ctk.CTkLabel(self.exclusao_frame, text="Tipo:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=5, column=0, padx=(40, 0), pady=(10, 0), sticky="e")
        self.entry_tipo = ctk.CTkComboBox(self.exclusao_frame, font=FONTE_TEXTO, values=["Pendência", "Troca"], width=150, height=30, corner_radius=2)
        self.entry_tipo.set("")
        self.entry_tipo.grid(row=5, column=1, padx=(10, 0), pady=(10, 0), sticky="w", columnspan=2)

        ctk.CTkLabel(self.exclusao_frame, text="Responsável:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=6, column=0, padx=(40, 0), pady=(10, 0), sticky="e")
        self.entry_responsavel = ctk.CTkEntry(self.exclusao_frame, font=FONTE_TEXTO, width=150, height=30, corner_radius=2)
        self.entry_responsavel.grid(row=6, column=1, padx=(10, 0), pady=(10, 0), sticky="w", columnspan=2)

        ctk.CTkLabel(self.exclusao_frame, text="Situação:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=7, column=0, padx=(40, 0), pady=(10, 0), sticky="e")
        self.entry_situacao = ctk.CTkComboBox(self.exclusao_frame, font=FONTE_TEXTO, values=["Pendente", "Entregue"], width=150, height=30, corner_radius=2)
        self.entry_situacao.set("")
        self.entry_situacao.grid(row=7, column=1, padx=(10, 0), pady=(10, 0), sticky="w", columnspan=2)

        ctk.CTkLabel(self.exclusao_frame, text="Carga Entregue:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=8, column=0, padx=(40, 0), pady=(10, 0), sticky="e")
        self.entry_carga_entregue = ctk.CTkEntry(self.exclusao_frame, font=FONTE_TEXTO, width=150, height=30, corner_radius=2)
        self.entry_carga_entregue.grid(row=8, column=1, padx=(10, 0), pady=(10, 0), sticky="w", columnspan=2)

        ctk.CTkFrame(self.exclusao_frame, height=2, fg_color=COR_LINHAS).grid(row=9, column=0, padx=(40, 290), pady=(15, 0), sticky="ew", columnspan=5)

        ctk.CTkLabel(self.exclusao_frame, text="Código Produto:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=10, column=0, padx=(40, 0), pady=(15, 0), sticky="e")
        self.entry_codigo_produto = ctk.CTkEntry(self.exclusao_frame, font=FONTE_TEXTO, width=100, height=30, corner_radius=2)
        ...
        self.label_descricao_produto = ctk.CTkLabel(self.exclusao_frame, text="", font=FONTE_TEXTO, text_color=COR_TEXTO)
        self.label_descricao_produto.grid(row=10, column=3, padx=(25, 0), pady=(15, 0), sticky="w")

        ctk.CTkLabel(self.exclusao_frame, text="Quantidade:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=11, column=0, padx=(40, 0), pady=(10, 0), sticky="e")
        self.entry_quantidade = ctk.CTkEntry(self.exclusao_frame, font=FONTE_TEXTO, width=100, height=30, corner_radius=2)
        self.entry_quantidade.grid(row=11, column=1, padx=(10, 0), pady=(10, 0))

        ctk.CTkFrame(self.exclusao_frame, height=2, fg_color=COR_LINHAS).grid(row=12, column=0, padx=(40, 290), pady=(15, 0), sticky="ew", columnspan=5)
