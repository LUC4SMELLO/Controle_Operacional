...
class EditarPendenciaView(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        ctk.CTkLabel(self.edicao_frame, text="Situação:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=7, column=0, padx=(40, 0), pady=(10, 0), sticky="e")
        self.entry_situacao = ctk.CTkComboBox(self.edicao_frame, font=FONTE_TEXTO, values=["Pendente", "Entregue"], width=150, height=30, corner_radius=2)
