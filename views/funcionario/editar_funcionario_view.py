...
class EditarFuncionarioView(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        self.edicao_frame_1 = ctk.CTkFrame(self.main_frame, fg_color="transparent")
        self.edicao_frame_1.grid_rowconfigure(0, weight=0)
        self.edicao_frame_1.grid_rowconfigure(1, weight=1)
        self.edicao_frame_1.grid_columnconfigure(0, weight=0)
        self.edicao_frame_1.grid_columnconfigure(1, weight=0)
        self.edicao_frame_1.grid_columnconfigure(2, weight=0)
        self.edicao_frame_1.grid_columnconfigure(3, weight=0)
        self.edicao_frame_1.grid_columnconfigure(4, weight=1)
        self.edicao_frame_1.grid(row=1, column=0, pady=(0, 0), sticky="ew")
        

        ctk.CTkLabel(self.edicao_frame_1, text="Código:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=0, column=0, padx=(116, 0), pady=(20, 0), sticky="e")
        ...
        self.edicao_frame_2 = ctk.CTkFrame(self.main_frame, fg_color="transparent")
        ...
        self.edicao_frame_2.grid_rowconfigure(4, weight=0)
        self.edicao_frame_2.grid_rowconfigure(5, weight=1)
        self.edicao_frame_2.grid_columnconfigure(0, weight=0)
        self.edicao_frame_2.grid_columnconfigure(1, weight=0)
        self.edicao_frame_2.grid_columnconfigure(2, weight=0)
        self.edicao_frame_2.grid_columnconfigure(3, weight=1)
        self.edicao_frame_2.grid_columnconfigure(4, weight=0)
        self.edicao_frame_2.grid(row=2, column=0, sticky="ew")
        

        ctk.CTkLabel(self.edicao_frame_2, text="Nome Completo:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=2, column=0, padx=(40, 0), pady=(20, 0), sticky="e")
        self.entry_nome_completo = ctk.CTkEntry(self.edicao_frame_2, font=FONTE_TEXTO, width=350, height=30, corner_radius=2)
        self.entry_nome_completo.grid(row=2, column=1, padx=(10, 0), pady=(20, 0), sticky="w")

        ctk.CTkLabel(self.edicao_frame_2, text="CPF:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=3, column=0, padx=(40, 0), pady=(5, 0), sticky="e")
        self.entry_cpf = ctk.CTkEntry(self.edicao_frame_2, font=FONTE_TEXTO, width=120, height=30, corner_radius=2)
        self.entry_cpf.grid(row=3, column=1, padx=(10, 0), pady=(5, 0), sticky="w")

        ctk.CTkLabel(self.edicao_frame_2, text="RG:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=4, column=0, padx=(40, 0), pady=(5, 0), sticky="e")
        self.entry_rg = ctk.CTkEntry(self.edicao_frame_2, font=FONTE_TEXTO, width=120, height=30, corner_radius=2)
        self.entry_rg.grid(row=4, column=1, padx=(10, 0), pady=(5, 0), sticky="w")

            
        ctk.CTkLabel(self.edicao_frame_2, text="Função:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=5, column=0, padx=(40, 0), pady=(5, 0), sticky="e")
        self.entry_funcao = ctk.CTkComboBox(self.edicao_frame_2, font=FONTE_TEXTO, values=["Motorista", "Ajudante"], width=120, height=30, corner_radius=2)
