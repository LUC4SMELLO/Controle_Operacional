...
class TelaPendenciaTroca(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        ctk.CTkLabel(self, text="Pendência & Troca", font=FONTE_TITULO).place(x=40, y=15)

        ctk.CTkLabel(self, text="Cadastrar", font=FONTE_SUBTITULO).place(x=40, y=65)

        ctk.CTkFrame(self, width=500, height=2, fg_color=COR_LINHAS).place(x=40, y=105)

        ctk.CTkLabel(self, text="Data:", font=FONTE_LABEL).place(x=135, y=130)
        ...
        ctk.CTkLabel(self, text="Carga:", font=FONTE_LABEL).place(x=127, y=165)
        ...
        ctk.CTkLabel(self, text="Código Cliente:", font=FONTE_LABEL).place(x=55, y=200)
        ...
        ctk.CTkLabel(self, text="Tipo:", font=FONTE_LABEL).place(x=138, y=235)
        ...
        ctk.CTkLabel(self, text="Responsável:", font=FONTE_LABEL).place(x=77, y=270)
        ...
        ctk.CTkLabel(self, text="Código Produto:", font=FONTE_LABEL).place(x=45, y=350)
        ...
        ctk.CTkLabel(self, text="Quantidade:", font=FONTE_LABEL).place(x=79, y=385)
        ...
        self.botao_confirmar = ctk.CTkButton(self, text="Confirmar", font=FONTE_BOTAO_SECUNDARIO, width=160, height=38)
        self.botao_confirmar.place(x=200, y=465)

        self.botao_cancelar= ctk.CTkButton(self, text="Cancelar", font=FONTE_BOTAO_SECUNDARIO, width=160, height=38)
