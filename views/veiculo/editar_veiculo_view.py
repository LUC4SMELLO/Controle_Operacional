...
class EditarVeiculoView(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        self.main_frame.grid_rowconfigure(1, weight=0) # EDIÇÃO 1
        self.main_frame.grid_rowconfigure(2, weight=0) # EDIÇÃO 2
        ...
        ctk.CTkLabel(self.edicao_frame_1, text="Código:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=0, column=0, padx=(122, 0), pady=(20, 0), sticky="e")
        ...
        self.edicao_frame_2.grid_columnconfigure(3, weight=0)
        self.edicao_frame_2.grid(row=2, column=0, sticky="ew")

        ctk.CTkLabel(self.edicao_frame_2, text="Placa:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=0, column=0, padx=(40, 0), pady=(20, 0), sticky="e")
    ...
    def confirmar(self):
        resultado = self.controller.confirmar_edicao_veiculo()
