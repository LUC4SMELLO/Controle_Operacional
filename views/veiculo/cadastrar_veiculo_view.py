...
class CadastrarVeiculoView(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        self.entry_codigo = ctk.CTkEntry(self.cadastro_frame, font=FONTE_TEXTO, text_color=COR_TEXTO, width=120, height=30, corner_radius=2)
        self.entry_codigo.grid(row=0, column=1, padx=(10, 0), pady=(20, 0), sticky="w")

        ctk.CTkLabel(self.cadastro_frame, text="Placa:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=1, column=0, padx=(40, 0), pady=(5, 0), sticky="e")
    ...
    def confirmar(self):
        resultado = self.controller.confirmar_cadastro_veiculo()
