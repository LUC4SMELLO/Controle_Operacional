...
class ExcluirVeiculoView(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        ctk.CTkLabel(self.exclusao_frame_2, text="Km:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=1, column=0, padx=(40, 0), pady=(5, 0), sticky="e")
        self.entry_km = ctk.CTkEntry(self.exclusao_frame_2, font=FONTE_TEXTO, text_color=COR_TEXTO, width=120, height=30, corner_radius=2)
        self.entry_km.grid(row=1, column=1, padx=(10, 0), pady=(5, 0), sticky="w")

        ctk.CTkLabel(self.exclusao_frame_2, text="Código Motorista:", font=FONTE_LABEL, text_color=COR_TEXTO).grid(row=2, column=0, padx=(40, 0), pady=(5, 0), sticky="e")
