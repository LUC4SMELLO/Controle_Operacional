...
def gerar_imagem_escala(escala):
    ...
    draw.text((1200, 40), data_formatada_extenso, fill="white", font=fonte_header)
    ...
    for i, item in enumerate(escala[:max_linhas]):
    ...
    img.save(REPORTS_IMAGES_DIR / "relatorio_entrega.png")
